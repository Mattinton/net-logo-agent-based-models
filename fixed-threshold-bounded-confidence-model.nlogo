...
to update-people
  ask people [
    ...
    ask one-of other people [
      ...
      if abs(([opinion] of person1) - ([opinion] of person2)) < threshold [
...
to interact [person1 person2]
  ...
  set opinion1 opinion1 + rate * (opinion2 - opinion1)
  set opinion2 opinion2 + rate * (opinion1 - opinion2)

  ask person1 [ set opinion opinion1 ]
  ask person2 [ set opinion opinion2 ]
end
@#$#@#$#@
GRAPHICS-WINDOW
209
