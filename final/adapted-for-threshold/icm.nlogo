...
people-own [ adopted adopted-at uncertainty pass-ons ]
...
to go
  ask people with [ adopted = "true" and adopted-at = (ticks - 1) ]
  [
    ask link-neighbors with [ adopted = "false" ]
    [
      if random-float 1 < uncertainty
      [
        set adopted "true"
        set adopted-at ticks
        ask myself
        [
          set pass-ons (pass-ons + 1)
        ]
        set color (list (127.5 + uncertainty * 127.25) 0 0)
      ]
    ]
  ...
  set current-R0 (mean [ pass-ons ] of people with [ adopted = "true" and adopted-at < ticks ])
  ifelse (current-R0 > 0)
  [
...
"" ""
PENS
"default" 1.0 0 -16777216 true "" "plot mean [ pass-ons ] of people with [ adopted = \"true\" and adopted-at < ticks - 1 ]"
...
<experiments>
  ...
  <experiment name="experiment" repetitions="20" runMetricsEveryStep="true">
    ...
    <metric>current-R0</metric>
    <metric>(count people with [ adopted = "true" ]) / (count people)</metric>
    <enumeratedValueSet variable="uncertainty-distribution">
      <value value="&quot;fixed&quot;"/>
      <value value="&quot;uniform&quot;"/>
      <value value="&quot;normal&quot;"/>
    </enumeratedValueSet>
