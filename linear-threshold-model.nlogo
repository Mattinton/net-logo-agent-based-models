...
people-own [ newly-adopted adopted threshold ]
...
to setup
  ...
  [
    ...
    [
      set adopted false
      set newly-adopted false
      set threshold (random-normal 0.5 0.1666666666) * population-threshold
...
to go
  ...
  [
    ...
    let neighbours-adopted-count count link-neighbors with [ adopted = true and newly-adopted = false ]

    if neighbours-adopted-count / neighbours-count >= threshold
    [
      set adopted true
      set newly-adopted true
      set color red
    ]
  ]

  ask people with [ newly-adopted = true ]
  [
    set newly-adopted false
  ]
